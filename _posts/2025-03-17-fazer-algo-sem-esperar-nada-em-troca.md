...
---
![Nem tudo precisa ser produtivo, só aproveite]({{ site.cdnimg }}/img/rising-tag.png)
...
![FILOSOFANDO: Um coração quente sempre importa]({{ site.cdnimg }}/img/filosofando.png)
...
![Desabafo de Peso]({{ site.cdnimg }}/img/desabafo.png)
